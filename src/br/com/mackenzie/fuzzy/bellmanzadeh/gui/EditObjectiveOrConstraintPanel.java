...
import br.com.mackenzie.fuzzy.bellmanzadeh.gui.actions.EditObjectiveOrConstraintAction;
...
public class EditObjectiveOrConstraintPanel extends MembershipPanel{
	...
	public EditObjectiveOrConstraintPanel(String fileName, JDialog dialog, MackTable table, JFrame owner)
	{
		super(fileName);
		this.dialog_ = dialog;
		this.table_  = table;
	...
	private JDialog getMembershipFunctionDialog()
	{
		if(membershipFunctionDialog_ == null) {
			membershipFunctionDialog_ = new JDialog(this.owner_, "Definir função de pertinência",  true);
	...
	private void buildButtons() {
		...
		addButton.setAction(new EditObjectiveOrConstraintAction(this, dialog_, table_));
